...
const alphabetChars = alphabetString.split('');
...
const myTodoList = ['check mail','get gas','change oil'];
console.log(myTodoList);

const myTodoEdit = myTodoList.splice(1,1);
console.log(myTodoList);

const yourTodoList = ['get groceries', 'get haircut'];
