...
var costGroceries = 500.00;
console.log("The cost of groceries are " + costGroceries);
...
var streetAddress = "123 Main St Akron, OH 44223"
console.log("A totally random, made-up address is: " + streetAddress);
...
//  ↓ YOUR CODE HERE ↓
console.log("A customer booked 2 seats... There are only " + (availableSeats - 2) + " seats left.");

    console.log('Buy a Candy Bar:')
//	Impulse candy bar purchase! Add 2.15 to the grocery total
//  ↓ YOUR CODE HERE ↓
console.log("Someone snuck in a candy bar to my grocery cart! (it defintely wasn't me...) The grocery total is now: " + (costGroceries + 2.15) )
...
//  ↓ YOUR CODE HERE ↓
var introduceCustomer = fullName + "I live at" + streetAddress;
